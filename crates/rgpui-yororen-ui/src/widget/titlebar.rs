...
impl Render for TitleBar {
    fn render(
        ...
        let drag_area = div()
            ...
            .window_control_area(rgpui::WindowControlArea::Drag)
            .h_full()
            .flex()
            .flex_row()
            .items_center()
        ...
        div()
            ...
            .when(cfg!(not(target_os = "macos")) && !is_tiled, |this| {
                this.children((0..3).map(|i| {
                    let (area, icon_path): (rgpui::WindowControlArea, SharedString) = match i {
                        0 => (
                            rgpui::WindowControlArea::Min,
                            "icons/window-minimize.svg".into(),
                        ),
                        1 => (
                            rgpui::WindowControlArea::Max,
