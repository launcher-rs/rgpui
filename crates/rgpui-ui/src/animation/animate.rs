//! 上层动画便捷构造器（基于核心 `rgpui::Animation`）。
//!
...
pub fn fade_in() -> AnimationPreset {
    AnimationPreset::new(Duration::from_millis(200), rgpui::ease_out_cubic)
}

/// 淡出预设。
pub fn fade_out() -> AnimationPreset {
    AnimationPreset::new(Duration::from_millis(200), rgpui::ease_in_cubic)
}

/// 上滑预设。
pub fn slide_up() -> AnimationPreset {
    AnimationPreset::new(Duration::from_millis(250), rgpui::ease_out_cubic)
}
