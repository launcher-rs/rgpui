...
mod tests {
    ...
    use rgpui::{AppContext as _, Render, Subscription};

    struct TestCollector {
        _state: rgpui::Entity<TreeState>,
        events: Rc<RefCell<Vec<TreeEvent>>>,
        _subscription: Subscription,
    }

    impl TestCollector {
        fn new(state: &rgpui::Entity<TreeState>, cx: &mut rgpui::Context<Self>) -> Self {
    ...
    #[rgpui::test]
    fn test_emits_expanded_event(cx: &mut rgpui::TestAppContext) {
        let items = vec![
    ...
    #[rgpui::test]
    fn test_emits_collapsed_event(cx: &mut rgpui::TestAppContext) {
        let items = vec![
    ...
    #[rgpui::test]
    fn test_set_items_does_not_emit_expansion_events(cx: &mut rgpui::TestAppContext) {
        let items = vec![
            super::TreeItem::new("src", "src")
                .expanded(true)
                .child(super::TreeItem::new("src/lib.rs", "lib.rs")),
