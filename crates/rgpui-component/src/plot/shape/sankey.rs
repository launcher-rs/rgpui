...
use rgpui::{Path, PathBuilder, Pixels, Point, px};
...
pub struct SankeyNodeLayout {
    ...
    /// scaled units, not raw values 鈥?read raw values from the input links.
    pub value: f64,
...
/// Build the filled ribbon path for a link 鈥?the equivalent of d3-sankey's
