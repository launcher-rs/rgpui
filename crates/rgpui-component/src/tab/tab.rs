...
impl Default for TabStyle {
    fn default() -> Self {
        TabStyle {
            ...
            bg: rgpui::transparent_white().into(),
            fg: rgpui::transparent_white(),
            shadow: false,
            inner_bg: rgpui::transparent_white().into(),
        }
    }
}
    ...
    fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        self.base
            ...
            .on_mouse_down(MouseButton::Left, |_, _, cx| {
                ...
                // https://github.com/longbridge/rgpui-component/issues/1836
                cx.stop_propagation();
            })
...
mod tests {
    ...
    #[rgpui::test]
    fn a11y_label_defaults_to_visible_label(_cx: &mut rgpui::TestAppContext) {
    ...
    #[rgpui::test]
    fn explicit_a11y_label_overrides_visible_label(_cx: &mut rgpui::TestAppContext) {
