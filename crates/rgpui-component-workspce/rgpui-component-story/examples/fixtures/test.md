...
Build Status [![Build Status](https://github.com/longbridge/rgpui-component/actions/workflows/ci.yml/badge.svg)](https://github.com/longbridge/rgpui-component/actions/workflows/ci.yml) of [rgpui Component](https://github.com/longbridge/rgpui-component).
...
fn main() {
    let _ = Repository {
        name: "rgpui Component".to_string(),
    };
