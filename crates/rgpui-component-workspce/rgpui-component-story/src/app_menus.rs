use rgpui::{App, Entity, Menu, MenuItem, SharedString};
use rgpui_component::{
...
fn build_menus(title: impl Into<SharedString>, cx: &App) -> Vec<Menu> {
    vec![
        ...
        Menu {
            name: "Edit".into(),
            items: vec![
                MenuItem::action("Undo", rgpui_component::input::Undo),
                MenuItem::action("Redo", rgpui_component::input::Redo),
                MenuItem::separator(),
                MenuItem::action("Cut", rgpui_component::input::Cut),
                MenuItem::action("Copy", rgpui_component::input::Copy),
                MenuItem::action("Paste", rgpui_component::input::Paste),
                MenuItem::separator(),
                MenuItem::action("Delete", rgpui_component::input::Delete),
                MenuItem::action(
                    "Delete Previous Word",
                    rgpui_component::input::DeleteToPreviousWordStart,
                ),
                MenuItem::action(
                    "Delete Next Word",
                    rgpui_component::input::DeleteToNextWordEnd,
                ),
                MenuItem::separator(),
                MenuItem::action("Find", rgpui_component::input::Search),
                MenuItem::separator(),
                MenuItem::action("Select All", rgpui_component::input::SelectAll),
            ],
            disabled: false,
        },
        Menu {
