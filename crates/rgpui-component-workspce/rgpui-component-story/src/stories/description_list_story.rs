...
use rgpui_component::{AxisExt, h_flex, menu::DropdownMenu as _};
use rgpui_component::{
    Sizable as _, Size,
    button::Button,
    checkbox::Checkbox,
...
impl DescriptionListStory {
    fn new(_: &mut Window, cx: &mut Context<Self>) -> Self {
        let items = vec![
            ("Name", "rgpui Component", 1),
            (
                "Description",
                "UI components for building fantastic desktop application by using [rgpui](https://rgpui.rs).\
                \n\n \
                Contains a lot of useful UI components, such as **Button**, **Input**, **Table**, **List**, **Select**, **DatePicker** ... \
                \n\n \
                You can easily create your native desktop application by using rgpui Component.
                ",
                3,
            ),
            ("Version", "0.1.0", 1),
            ...
            (
                "Repository",
                "https://github.com/longbridge/rgpui-component",
                2,
            ),
            (
                "Category",
