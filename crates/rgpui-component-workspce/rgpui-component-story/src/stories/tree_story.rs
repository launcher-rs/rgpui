...
fn example_file_items() -> Vec<TreeItem> {
    vec![
        TreeItem::new("rgpui-component", "rgpui-component")
            .expanded(true)
            .children([
                TreeItem::new("rgpui-component/crates", "crates")
                    .expanded(true)
                    .children([
                        TreeItem::new("rgpui-component/crates/ui", "ui")
                            .expanded(true)
                            .children([
                                TreeItem::new("rgpui-component/crates/ui/src", "src").children([
                                    TreeItem::new(
                                        "rgpui-component/crates/ui/src/tree.rs",
                                        "tree.rs",
                                    ),
                                    TreeItem::new(
                                        "rgpui-component/crates/ui/src/list/mod.rs",
                                        "mod.rs",
                                    ),
                                ]),
                                TreeItem::new("rgpui-component/crates/ui/Cargo.toml", "Cargo.toml"),
                            ]),
                        TreeItem::new("rgpui-component/crates/story", "story").children([
                            TreeItem::new(
                                "rgpui-component/crates/story/src/stories/tree_story.rs",
                                "tree_story.rs",
                            ),
                            TreeItem::new(
                                "rgpui-component/crates/story/src/gallery.rs",
                                "gallery.rs",
                            ),
                        ]),
                    ]),
                TreeItem::new("rgpui-component/README.md", "README.md"),
            ]),
    ]
}
...
impl TreeStory {
    ...
    fn on_action_rename(&mut self, _: &Rename, _: &mut Window, cx: &mut rgpui::Context<Self>) {
    ...
    fn on_action_open(&mut self, _: &OpenFile, _: &mut Window, cx: &mut rgpui::Context<Self>) {
        if let Some(entry) = self.tree_state.read(cx).selected_entry() {
            let item = entry.item();
    ...
    fn on_action_delete(&mut self, _: &Delete, _: &mut Window, cx: &mut rgpui::Context<Self>) {
        if let Some(entry) = self.tree_state.read(cx).selected_entry() {
            let item = entry.item();
