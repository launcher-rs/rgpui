    ...
    fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        let textarea = cx.new(|cx| {
            InputState::new(window, cx)
                ...
                .default_value(
                    unindent::unindent(
                        r#"Hello 世界，this is rgpui component.

                    The rgpui Component is a collection of UI components for rgpui framework, including.

                    Button, Input, Checkbox, Radio, Dropdown, Tab, and more...

                    Here is an application that is built by using rgpui Component.
        ...
        let textarea_auto_grow_no_wrap = cx.new(|cx| {
            InputState::new(window, cx)
                ...
                .soft_wrap(false)
                .placeholder("Enter text here...")
                .default_value("Hello 世界，this is rgpui component.")
        });
...
impl Focusable for TextareaStory {
    fn focus_handle(&self, cx: &rgpui::App) -> rgpui::FocusHandle {
