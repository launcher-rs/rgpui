...
impl Render for NativeMenuStory {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(section("From rgpui::Menu items").child(
                self.trigger("Right-click here", cx).on_mouse_down(
                    MouseButton::Right,
                    cx.listener(|this, ev: &MouseDownEvent, window, cx| {
                        this.focus_handle.focus(window, cx);
                        ...
                        // Reuse a rgpui menu definition (incl. a submenu) directly.
                        NativeMenu::from(rgpui::Menu::new("Edit").items([
                            rgpui::MenuItem::action("Copy", MenuClick("Copy".into())),
                            rgpui::MenuItem::action("Paste", MenuClick("Paste".into())),
                            rgpui::MenuItem::separator(),
                            rgpui::MenuItem::submenu(rgpui::Menu::new("Share").items([
                                rgpui::MenuItem::action("Email", MenuClick("Email".into())),
                                rgpui::MenuItem::action("Message", MenuClick("Message".into())),
                            ])),
                        ]))
