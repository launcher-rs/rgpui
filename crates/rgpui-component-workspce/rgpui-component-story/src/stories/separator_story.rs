...
use rgpui_component::{ActiveTheme, h_flex, label::Label, separator::Separator, v_flex};

const DESCRIPTION: &str = "rgpui Component is a Rust GUI components for building fantastic cross-platform desktop application by using rgpui.";
            ...
            .child(
                section("Combination Separators").child(
                    v_flex()
                        .gap_y_4()
                        .child(
                            v_flex().gap_y_2().child("Hello rgpui Component").child(
