...
use rgpui_component::group_box::{GroupBox, GroupBoxVariants as _};
use rgpui_component::label::Label;
use rgpui_component::tag::Tag;
use rgpui_component::{ActiveTheme, IconName, StyledExt, h_flex};
use rgpui_component::{
    Sizable,
