            ...
            SettingPage::new("About")
                ...
                .group(SettingGroup::new().title("Links").items(vec![
                        ...
                        SettingItem::new(
                            ...
                            SettingField::element(OpenURLSettingField::new(
                                "Rust Docs...",
                                "https://docs.rs/rgpui-component"
                            )),
                        )
                        .description(markdown(
                            "Rust doc for the `rgpui-component` crate.",
                        )),
                        SettingItem::new(
                            "Website",
                            SettingField::render(|options, _window, _cx| {
                                Button::new("open-url")
                                    ...
                                    .on_click(|_, _window, cx| {
                                        cx.open_url("https://github.com/launcher-rs/rgpui");
                                    })
                            }),
                        )
                        .description("Official website and documentation for the rgpui Component."),
                    ])),
        ]
    }
}
