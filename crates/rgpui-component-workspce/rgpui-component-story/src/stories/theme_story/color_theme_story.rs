...
impl ThemeColorsStory {
    ...
    fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        use rgpui_component::ThemeRegistry;
    ...
    fn get_theme_colors(&self, cx: &Context<Self>) -> ThemeColor {
        use rgpui_component::{Theme as UITheme, ThemeRegistry};
    ...
    fn render_color_swatch(
        ...
        use rgpui_component::{WindowExt as _, clipboard::Clipboard};
...
fn format_colors(
    theme: &ThemeColor,
    config: Option<&rgpui_component::theme::ThemeConfigColors>,
) -> Vec<ColorCategory> {
                    ...
                    .child(
                        Button::new("set_theme")
                            ...
                            .on_click(cx.listener(|this, _, window, cx| {
                                use rgpui_component::{Theme, ThemeRegistry};
