# rgpui Component Story Web

Web-based component gallery for rgpui Component library.

**Live Demo**: https://longbridge.github.io/rgpui-component/gallery/
...
- Base path set to `/rgpui-component/gallery/` for GitHub Pages

The output will be in `www/dist/` directory.

## Deployment

The gallery is automatically deployed to GitHub Pages at `/rgpui-component/gallery/` when docs are released.
