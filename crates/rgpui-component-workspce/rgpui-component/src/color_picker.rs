...
impl ColorPickerState {
    ...
    fn update_value(
        ...
        // the Hsla鈫抙ex鈫扝sla precision loss from feeding back into sync_sliders.
        ...
        // on the InputEvent::Change 鈫?parse_hex round-trip.
    ...
    fn update_value_from_slider(
        ...
        // InputEvent::Change to avoid the Hsla鈫抙ex鈫扝sla precision loss loop.
        self.suppress_input_change = true;
        self.state.update(cx, |view, cx| {
            view.set_value(value.to_hex(), window, cx);
        });
