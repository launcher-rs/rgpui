/// WrapMap: Soft-wrapping layer (Buffer 鈫?Wrap rows).
///
/// This module wraps the existing TextWrapper and provides:
/// - BufferPoint 鈫?WrapPoint mapping
/// - Efficient buffer_line 鈫?wrap_row queries via prefix sum cache
...
/// WrapMap manages soft-wrapping and provides buffer 鈫?wrap coordinate mapping.
///
/// Buffer line 鈫?wrap row mapping is backed by the [`TextWrapper`]'s `SumTree`.
pub struct WrapMap {
