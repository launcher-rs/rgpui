...
use rgpui::sum_tree::{Bias, Dimensions, SumTree};
...
impl rgpui::sum_tree::Summary for LineSummary {
    type Context<'a> = &'a ();
...
impl rgpui::sum_tree::Item for LineItem {
...
impl<'a> rgpui::sum_tree::Dimension<'a, LineSummary> for BufferRows {
    fn zero(_: &()) -> Self {
        BufferRows(0)
    }
...
impl<'a> rgpui::sum_tree::Dimension<'a, LineSummary> for WrapRows {
    fn zero(_: &()) -> Self {
        WrapRows(0)
    }
