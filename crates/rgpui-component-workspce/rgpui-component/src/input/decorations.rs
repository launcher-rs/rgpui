...
///
/// This is the rgpui [`HighlightStyle`] counterpart of Monaco's
...
impl TextDecoration {
    /// Create a text decoration from a UTF-8 byte range and a rgpui style.
...
///
/// This is the rgpui Component counterpart of Monaco's
...
mod tests {
    ...
    fn collections_are_independent_and_ranges_are_clipped() {
        ...
        let first_style = HighlightStyle {
            font_weight: Some(rgpui::FontWeight::BOLD),
            ..Default::default()
        };
