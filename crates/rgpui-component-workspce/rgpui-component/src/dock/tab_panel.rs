...
struct DropPlaceholderBounds {
    origin: Point<Pixels>,
    size: rgpui::Size<Pixels>,
}

impl DropPlaceholderBounds {
    fn for_placement(bounds: rgpui::Bounds<Pixels>, placement: Option<Placement>) -> Self {
        ...
        match placement {
            Some(Placement::Left) => Self {
                ...
                size: rgpui::size(half_width, bounds.size.height),
            },
            ...
            Some(Placement::Top) => Self {
                origin: Point::default(),
                size: rgpui::size(bounds.size.width, half_height),
            },
...
mod tests {
    ...
    use rgpui::{TestAppContext, VisualTestContext, WindowHandle};
    ...
    fn drop_placeholder_bounds_cover_each_target_placement() {
        let bounds = rgpui::Bounds {
            origin: point(px(120.), px(80.)),
            size: rgpui::size(px(400.), px(300.)),
        };
