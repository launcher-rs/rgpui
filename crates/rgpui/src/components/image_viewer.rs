...
use crate::{Button, Focusable, IconName, prelude::FluentBuilder as _, *};
use std::rc::Rc;
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child({
                        let viewer_entity = viewer_entity;
                ...
                |this, caption| {
                    this.child(
                        div()
                            ...
                            .py(px(8.0))
                            .text_size(px(14.0))
                            .text_color(crate::white().opacity(0.8))
                            .font_family(font_family.clone())
                            .text_center()
                            .child(caption),
                    )
