...
use crate::{Menu, MenuItem, SharedString, StyleRefinement, Styled, SystemMenuType};
...
impl AppMenu {
    ...
    /// 添加一个执行操作的菜单项。
    pub fn action<A: crate::Action>(mut self, label: impl Into<SharedString>, action: A) -> Self {
