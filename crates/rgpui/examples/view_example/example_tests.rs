...
//!
//! ```sh
//! cargo test -p rgpui --example view_example --features test-support
//! ```

#[cfg(test)]
mod tests {
    use rgpui::{Context, Entity, KeyBinding, TestAppContext, Window, prelude::*};
    ...
    fn external_writes_clamp_the_cursor(cx: &mut TestAppContext) {
        ...
        cx.read_entity(&a_value, |value, _| assert_eq!(value, "鏃ユ湰"));
