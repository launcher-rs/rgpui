...
/// macOS 平台实现，实现了 `rgpui::Platform` trait。
...
impl MacPlatform {
    ...
    pub fn new(headless: bool) -> Self {
        ...
        let text_system = Arc::new(rgpui::NoopTextSystem::new());
            ...
            match item {
                ...
                MenuItem::Action {
                    ...
                    let selector = match os_action {
                        Some(rgpui::OsAction::Cut) => selector("cut:"),
                        Some(rgpui::OsAction::Copy) => selector("copy:"),
                        Some(rgpui::OsAction::Paste) => selector("paste:"),
                        Some(rgpui::OsAction::SelectAll) => selector("selectAll:"),
                        // 在我们的情况下，"undo:" 和 "redo:" 始终被禁用，因为
                        // 我们没有 NSTextView/NSTextField 来启用它们。
                        Some(rgpui::OsAction::Undo) => selector("handleGPUIMenuItem:"),
                        Some(rgpui::OsAction::Redo) => selector("handleGPUIMenuItem:"),
...
impl Platform for MacPlatform {
    ...
    fn foreground_executor(&self) -> rgpui::ForegroundExecutor {
    ...
    fn screen_capture_sources(
        &self,
    ) -> oneshot::Receiver<Result<Vec<Rc<dyn rgpui::ScreenCaptureSource>>>> {
