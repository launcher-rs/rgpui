...
> 上游文档：`docs/history/upstream-separation-strategy.md`（切割战略）、`docs/history/component-integration-plan.md`（组件整合，已全部完成）
...
- 更新：`AGENTS.md`（架构图、命令说明、完整性检查清单）、`docs/history/upstream-separation-strategy.md`、`docs/rgpui-book/08-components.md`。
