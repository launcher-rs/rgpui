...
>
> 上游文档：`docs/history/upstream-separation-strategy.md`（切割战略）、`docs/history/ui-crate-plan.md`（UI 重组）、`docs/history/research-text-selection.md`（文本选择调研）
>
> 支撑分析：`docs/history/web-dom-backend-analysis.md`（参考 dioxus / topcoat / Flutter Web 的深入调研，2026-08-19）
