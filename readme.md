...
项目中的大部分功能已拆分到独立仓库，便于独立发布和演进：

| 仓库 | 说明 |
|------|------|
| [rgpui-character](https://github.com/launcher-rs/rgpui-character) | rgpui 桌宠与 UI 角色运行时系统 |
| [rgpui-term](https://github.com/launcher-rs/rgpui-term) | 终端模拟器组件 |
| [rgpui-component](https://github.com/launcher-rs/rgpui-component) | 通用 UI 组件库 |
| [rgpui-yororen-ui](https://github.com/launcher-rs/rgpui-yororen-ui) | yororen UI 组件集 |
| [rgpui-adabraka-ui](https://github.com/launcher-rs/rgpui-adabraka-ui) | adabraka UI 组件集 |
